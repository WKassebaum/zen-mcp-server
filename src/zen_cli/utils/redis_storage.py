...
class RedisStorage:
    ...
    def set_with_ttl(self, key: str, ttl_seconds: int, value: str) -> None:
        """
        Store value with expiration time in Redis.
        ...
        try:
            ...
            self.redis.setex(namespaced_key, ttl_seconds, value)
    ...
    def get(self, key: str) -> Optional[str]:
        """
        Retrieve value from Redis if not expired.
    ...
    def setex(self, key: str, ttl_seconds: int, value: str) -> None:
        """Redis-compatible setex method (alias for set_with_ttl)"""
...
REDIS_CONFIGS = {
    'local': {
        ...
        'port': 6379,
        'db': 0,
        'key_prefix': 'zen:local:'
    },
    'docker': {
        'host': 'redis',  # Docker service name
        'port': 6379,
        'db': 0,
        'key_prefix': 'zen:docker:'
    },
    'production': {
