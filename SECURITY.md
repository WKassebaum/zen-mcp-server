...
ZEN MCP is an open-source Model Context Protocol (MCP) server that acts as middleware between AI clients (Claude Code, Codex CLI, Cursor, etc.) and various AI model providers.
...
- **User Responsibility**: The AI client (not ZEN MCP) controls tool invocations and workflows. Users are responsible for reviewing AI-generated outputs and actions.
...
- **Third-Party Services**: ZEN MCP connects to external AI providers (Google, OpenAI, Azure, etc.). Their terms of service and privacy policies apply to data sent through this server.
...
Use [GitHub Security Advisories](https://github.com/BeehiveInnovations/zen-mcp-server/security/advisories/new) to report vulnerabilities privately.
