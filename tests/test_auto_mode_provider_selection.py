...
class TestAutoModeProviderSelection:
    ...
    def test_openai_only_fallback_selection(self):
        ...
        try:
            ...
            # Should select appropriate OpenAI models (5.4 series now preferred for power/coding)
            assert extended_reasoning in (
                "gpt-5.4-pro",
                "gpt-5.4",
            ), f"Expected GPT-5.4 variant, got '{extended_reasoning}'"
    ...
    def test_alias_resolution_before_api_calls(self):
        ...
        try:
            ...
            test_cases = [
                ...
                ("grok", ProviderType.XAI, "grok-4.20-beta-0309-reasoning"),
